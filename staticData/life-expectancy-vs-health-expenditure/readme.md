...
This data package contains the data that powers the chart ["Life expectancy vs. health spending"](https://ourworldindata.org/grapher/life-expectancy-vs-health-expenditure?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website.
...
#### Full citation
OECD (2025) – with minor processing by Our World in Data. “Health expenditure per capita - Total” [dataset]. OECD, “OECD Health Expenditure and Financing Database” [original data].
Source: OECD (2025) – with minor processing by Our World In Data

### What you should know about this data
* The data is measured in international-$ at 2020 prices – this adjusts for inflation and for differences in the cost of living between countries.
